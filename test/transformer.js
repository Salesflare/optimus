...
describe('transformer', () => {
    ...
    it('should transform tag used is true to is not null', () => {
    ...
    it('should transform tag used is false to is null', () => {
    ...
    it('should not transform tag used if value not array', () => {
